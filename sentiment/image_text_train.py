...
transform = transforms.Compose([transforms.ToTensor(),transforms.Normalize((0.1307,), (0.3081,))])  # 将列表变换为相应的tensor
...
def main():
    ...
    cache_dev_file = '/nas/lishengping/temp/2_eval_featu222.pkl'
    cache_train_file = '/nas/lishengping/temp/2_train_features_ca222che_half.pkl'
